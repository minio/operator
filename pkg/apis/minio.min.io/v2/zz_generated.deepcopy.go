...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StatefulSetMetadata) DeepCopyInto(out *StatefulSetMetadata) {
	*out = *in
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StatefulSetMetadata.
func (in *StatefulSetMetadata) DeepCopy() *StatefulSetMetadata {
	if in == nil {
		return nil
	}
	out := new(StatefulSetMetadata)
	in.DeepCopyInto(out)
	return out
}
