...
var policybindingsResource = v1beta1.SchemeGroupVersion.WithResource("policybindings")

var policybindingsKind = v1beta1.SchemeGroupVersion.WithKind("PolicyBinding")
...
func (c *FakePolicyBindings) Apply(ctx context.Context, policyBinding *stsminiov1beta1.PolicyBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.PolicyBinding, err error) {
...
func (c *FakePolicyBindings) ApplyStatus(ctx context.Context, policyBinding *stsminiov1beta1.PolicyBindingApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.PolicyBinding, err error) {
	if policyBinding == nil {
		return nil, fmt.Errorf("policyBinding provided to Apply must not be nil")
	}
	data, err := json.Marshal(policyBinding)
