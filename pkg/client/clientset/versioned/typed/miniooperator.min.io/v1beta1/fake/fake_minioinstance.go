...
var minioinstancesResource = schema.GroupVersionResource{Group: "miniooperator.k8s.io", Version: "v1beta1", Resource: "minioinstances"}

var minioinstancesKind = schema.GroupVersionKind{Group: "miniooperator.k8s.io", Version: "v1beta1", Kind: "MinIOInstance"}
