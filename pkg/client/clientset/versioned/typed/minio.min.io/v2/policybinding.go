...
type PolicyBindingInterface interface {
	Create(ctx context.Context, policyBinding *v2.PolicyBinding, opts v1.CreateOptions) (*v2.PolicyBinding, error)
	Update(ctx context.Context, policyBinding *v2.PolicyBinding, opts v1.UpdateOptions) (*v2.PolicyBinding, error)
	UpdateStatus(ctx context.Context, policyBinding *v2.PolicyBinding, opts v1.UpdateOptions) (*v2.PolicyBinding, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v2.PolicyBinding, error)
	List(ctx context.Context, opts v1.ListOptions) (*v2.PolicyBindingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.PolicyBinding, err error)
...
func newPolicyBindings(c *MinioV2Client, namespace string) *policyBindings {
...
func (c *policyBindings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2.PolicyBinding, err error) {
	result = &v2.PolicyBinding{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *policyBindings) List(ctx context.Context, opts v1.ListOptions) (result *v2.PolicyBindingList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2.PolicyBindingList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("policybindings").
...
func (c *policyBindings) Create(ctx context.Context, policyBinding *v2.PolicyBinding, opts v1.CreateOptions) (result *v2.PolicyBinding, err error) {
	result = &v2.PolicyBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("policybindings").
...
func (c *policyBindings) Update(ctx context.Context, policyBinding *v2.PolicyBinding, opts v1.UpdateOptions) (result *v2.PolicyBinding, err error) {
	result = &v2.PolicyBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policybindings").
...
func (c *policyBindings) UpdateStatus(ctx context.Context, policyBinding *v2.PolicyBinding, opts v1.UpdateOptions) (result *v2.PolicyBinding, err error) {
	result = &v2.PolicyBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("policybindings").
...
func (c *policyBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2.PolicyBinding, err error) {
	result = &v2.PolicyBinding{}
