	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MiniooperatorV1beta1().MinIOInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MiniooperatorV1beta1().MinIOInstances(namespace).Watch(context.TODO(), options)
			},
		},
		&miniooperatorminiov1beta1.MinIOInstance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *minIOInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&miniooperatorminiov1beta1.MinIOInstance{}, f.defaultInformer)
}
