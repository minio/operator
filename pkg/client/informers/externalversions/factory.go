...
import (
	...
	policyminio "github.com/minio/operator/pkg/client/informers/externalversions/policy.min.io"
...
func (f *sharedInformerFactory) Policy() policyminio.Interface {
	return policyminio.New(f, f.namespace, f.tweakListOptions)
}
