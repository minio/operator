	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MinioV2().PolicyBindings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MinioV2().PolicyBindings(namespace).Watch(context.TODO(), options)
			},
		},
		&miniominiov2.PolicyBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&miniominiov2.PolicyBinding{}, f.defaultInformer)
}

func (f *policyBindingInformer) Lister() v2.PolicyBindingLister {
	return v2.NewPolicyBindingLister(f.Informer().GetIndexer())
}
