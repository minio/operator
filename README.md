...
Starting with Operator v6.0.0, MinIO requires Kubernetes version 1.25.0 or later. You must upgrade your Kubernetes
cluster to 1.25.0 or later to use Operator
v6.0.0+.
