...
:console-image: https://hub.docker.com/r/minio/console/tags[minio/console:v0.6.8]
...
:logsearch-image: https://hub.docker.com/r/minio/logsearchapi/tags[minio/logsearchapi:v4.0.9]
