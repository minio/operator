...
func newTenantCreateCmd(out io.Writer, errOut io.Writer) *cobra.Command {
	...
	f.StringVar(&c.tenantOpts.ConsoleImage, "console-image", helpers.DefaultConsoleImage, "Tenant console image for this tenant")
	f.StringVar(&c.tenantOpts.TenantAccessKey, "tenant-access-key", "", "Access key for this tenant")
	f.StringVar(&c.tenantOpts.TenantSecretKey, "tenant-secret-key", "", "Secret key for this tenant")
