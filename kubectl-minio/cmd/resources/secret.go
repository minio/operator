...
// NewSecretForMinIOInstance will return a new secret a MinIO Cluster tenant
func NewSecretForMinIOInstance(name, ns, accessKey, secretKey string) *corev1.Secret {
